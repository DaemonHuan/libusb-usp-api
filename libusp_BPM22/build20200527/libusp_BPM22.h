...
//    LIBUSP_BPM22_API int dll_test(int aa);
    ...
    // Debug model
    LIBUSP_BPM22_API int dm_cmdcoder(const char *iData, int iLength);

    LIBUSP_BPM22_API int dm_cmddecoder(char *iData, int &iLength);
    ...
    LIBUSP_BPM22_API int dm_ctl_stepMotor(short i_id, short i_enabled, short i_dirt,
    		int i_speed, int i_steps);

    LIBUSP_BPM22_API int dm_ctl_dcMotor(short i_id, short i_enabled, short i_dirt,
    		int i_speed);
